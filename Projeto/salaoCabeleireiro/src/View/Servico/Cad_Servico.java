 ...
 * @author Douglas
 */
public class Cad_Servico extends javax.swing.JDialog {
    private Point point = new Point();
    private final ControllerServico controleServicos;
    /**
     * Creates new form Cad_Servico
     */
    public Cad_Servico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controleServicos = new ControllerServico(this, null, null);
    }
    
    public void tremeTela(){
        Point p = this.getLocation();
        Cad_Servico cad_servico = this;
        new Thread(){
            @Override
            public void run() {
                try{
                    for (int i = 0; i < 4; i++) {
                    cad_servico.setLocation(p.x - 10, p.y);
                    sleep(20);
                    cad_servico.setLocation(p.x + 10, p.y);
                    sleep(20);
                    }
                    cad_servico.setLocation(p.x, p.y);
    ...
    */
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonCadastrar, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(113, 113, 113))
        );
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        controleServicos.validaCamposCad(jTextFieldNome.getText(), jTextFieldPreco.getText(), jTextAreaDescricao.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cad_Servico dialog = new Cad_Servico(new javax.swing.JFrame(), true);
