...
public class Consulta_Servico extends javax.swing.JDialog {
     ...
     */
    public Consulta_Servico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerServico(null, this, null);
        controle.carregarLista(jTableServico);
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        if (jTableServico.getColumnModel().getColumnCount() > 0) {
            jTableServico.getColumnModel().getColumn(0).setPreferredWidth(50);
            jTableServico.getColumnModel().getColumn(0).setMaxWidth(50);
            jTableServico.getColumnModel().getColumn(1).setMinWidth(100);
            jTableServico.getColumnModel().getColumn(1).setPreferredWidth(250);
            jTableServico.getColumnModel().getColumn(1).setMaxWidth(300);
            jTableServico.getColumnModel().getColumn(2).setPreferredWidth(100);
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        if(jTableServico.getSelectedRow() > -1){
            controle.resgatarRegistro(jTableServico);
            controle.carregarLista(jTableServico);
        }else{
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(jTableServico.getSelectedRow() > -1){
            controle.confirma((String)jTableServico.getValueAt(jTableServico.getSelectedRow(), 0));
        }else{
            caixaMensagem("Selecione uma linha primeiro", "Nenhuma linha selecionada", 0);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Consulta_Servico dialog = new Consulta_Servico(new javax.swing.JFrame(), true);
