...
public class Cad_Funcionario extends javax.swing.JDialog {
    ...
    public Cad_Funcionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerFuncionario(this, null, null);
        controle.carregarListaServicos(jTableServicosDisp);
    }
    
    public void tremeTela(){
        Point p = this.getLocation();
        Cad_Funcionario funcionario = this;
        new Thread(){
            @Override
            public void run() {
                try{
                    for (int i = 0; i < 4; i++) {
                    funcionario.setLocation(p.x - 10, p.y);
                    sleep(20);
                    funcionario.setLocation(p.x + 10, p.y);
                    sleep(20);
                    }
                    funcionario.setLocation(p.x, p.y);
    ...
    */
    ...
    public void alteraCorTabelaVazia(){
        jButtonAdd.setBackground(new Color(255, 200, 200));
    }
    ...
    public void cadastroSucesso(){
        caixaMensagem("Funcionário cadastrado com sucesso!", "Sucesso", 1);
        this.dispose();
    ...
    private void initComponents() {
        ...
        jButtonAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/Cad_Funcionario/setaAddEsquerda.png"))); // NOI18N
        ...
        jButtonExcl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Icon/Cad_Funcionario/setaRmvDireita.png"))); // NOI18N
        jButtonExcl.setBorder(null);
        jButtonExcl.setContentAreaFilled(false);
        jButtonExcl.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButtonExcl, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        controle.validaCamposCad(jTextFieldNome.getText(), jFormattedTextFieldCpf.getText(),jTextFieldEmail.getText(), jTextFieldTelefone.getText(), jTextFieldUsuario.getText(), jPasswordFieldSenha.getText(), jPasswordFieldConfirmaSenha.getText(), jTableServicosAdd.getRowCount());
