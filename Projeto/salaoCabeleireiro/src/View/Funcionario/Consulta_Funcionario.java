...
public class Consulta_Funcionario extends javax.swing.JDialog {
    ...
    public final ControllerFuncionario controle;
    ...
    public Consulta_Funcionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerFuncionario(null, this, null);
        controle.carregarLista(jTableFuncionarios);
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jTableFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "E-mail", "Telefone", "Usuário", "Senha", "Serviços"
            }
        ) {
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        if(jTableFuncionarios.getSelectedRow() > -1){
            new Altera_Funcionario(null, true, controle.resgatarRegistro(jTableFuncionarios)).setVisible(true);
        }else{
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(jTableFuncionarios.getSelectedRow() > -1){
            controle.confirma((String)jTableFuncionarios.getValueAt(jTableFuncionarios.getSelectedRow(), 0));
        }else{
            caixaMensagem("Selecione uma linha primeiro", "Nenhuma linha selecionada", 0);
        }
