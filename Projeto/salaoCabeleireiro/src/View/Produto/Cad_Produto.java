 ...
 * @author Douglas
 */
public class Cad_Produto extends javax.swing.JDialog {
     ...
     */
    public Cad_Produto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerProduto(this, null, null);
    }
    
    public void tremeTela(){
        Point p = this.getLocation();
        Cad_Produto cad_produto = this;
        new Thread(){
            @Override
            public void run() {
                try{
                    for (int i = 0; i < 4; i++) {
                    cad_produto.setLocation(p.x - 10, p.y);
                    sleep(20);
                    cad_produto.setLocation(p.x + 10, p.y);
                    sleep(20);
                    }
                    cad_produto.setLocation(p.x, p.y);
                }catch(InterruptedException ex){
                    Logger.getLogger(Cad_Produto.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    */
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        controle.validaCamposCad(jTextFieldNome.getText(), jTextFieldPreco.getText(), jFormattedTextFieldValidade.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cad_Produto dialog = new Cad_Produto(new javax.swing.JFrame(), true);
