 ...
 * @author Douglas
 */
public class Consulta_Produto extends javax.swing.JDialog {
     ...
     */
    public Consulta_Produto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerProduto(null, this, null);
        controle.carregarLista(jTableProdutos);
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jButtonAdicionar.setBackground(new java.awt.Color(0, 0, 0));
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        if(jTableProdutos.getSelectedRow() > -1){
            new Altera_Produto(null, true, controle.resgatarRegistro(jTableProdutos)).setVisible(true);
        }else{
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(jTableProdutos.getSelectedRow() > -1){
            controle.confirma((String)jTableProdutos.getValueAt(jTableProdutos.getSelectedRow(), 0));
        }else{
            caixaMensagem("Selecione uma linha primeiro", "Nenhuma linha selecionada", 0);
        }
    ...
    private void jButtonAdicionarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAdicionarMouseEntered
        jButtonAdicionar.setBackground(Color.gray);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consulta_Produto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Consulta_Produto dialog = new Consulta_Produto(new javax.swing.JFrame(), true);
