...
public class Consulta_Cliente extends javax.swing.JDialog {
    ...
    public Consulta_Cliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        controle = new ControllerCliente(null, this, null);
        controle.carregarLista(jTableClientes);
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jTableClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Nascimento", "E-mail", "Telefone", "Usuário", "Senha"
            }
        ) {
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        if(jTableClientes.getSelectedRow() > -1){
            ArrayList<String> dados = controle.resgatarRegistro(jTableClientes);
            if(dados != null){
                new Altera_Cliente(null, true, dados).setVisible(true);
            }
        }else{
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(jTableClientes.getSelectedRow() > -1){
            controle.confirma((String)jTableClientes.getValueAt(jTableClientes.getSelectedRow(), 0));
        }else{
            caixaMensagem("Selecione uma linha primeiro", "Nenhuma linha selecionada", 0);
        }
