 ...
 * @author Douglas
 */
public class Reg_Agendamento extends javax.swing.JDialog {
    private Point point = new Point();
    private final ControllerAgendamento controle;
     ...
     */
    public Reg_Agendamento(java.awt.Frame parent, boolean modal, String codigo, String usuario, String senha) {
        super(parent, modal);
        initComponents();
        controle = new ControllerAgendamento(this, null, null, null, null);
    ...
    public void tremeTela(){
        ...
        Reg_Agendamento agendamento = this;
        new Thread(){
            @Override
            public void run() {
                try{
                    ...
                    Logger.getLogger(Reg_Agendamento.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    */
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        controle.validaCamposCad(jFormattedTextFieldData.getText(), jFormattedTextFieldHora.getText(), codigo, usuario, senha, jTableServicosAdd.getRowCount());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reg_Agendamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Reg_Agendamento dialog = new Reg_Agendamento(new javax.swing.JFrame(), true, null, null, null);
